...
const inviteCodes = [
  `A3o7hSQgCGp-83eBHC__Q@AUWE5m6-VyTAADjar1H1JnQ@AUWE5zurQjWZXbBarphUv@AUWE5_9nGp1FsSCeipy02@AUWE5mqiXyT0KDGeu33gYnA@AUWE5m6yVzzwJDmT_3HsZwQ@AUWE5x-_at3RKYDuQiTYI@AUWE53fnRkW5cfSinnyMY
`]
!(async () => {
  $.tuanList = []
  await requireConfig();
